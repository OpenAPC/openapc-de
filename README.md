...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |152,429 | 292,302,134    | 357 |
...
The article data set contains information on 152,429 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 357 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 292,302,134. The average payment was € 1,918 and the median was € 1,752.

101,058 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 164,708,228, including value-added tax; the average payment was € 1,630 (median =  € 1,559, SD = € 769).

Hybrid open access journals rely on both publication fees and subscriptions as revenue source. 51,371 articles in the data set were published in hybrid journals. Total expenditure amounts to 127,593,906 €; the average fee was € 2,484 (median =  € 2,445, SD = € 994).
...
|2021   |       8,554|   1,776|     1,753|  27 -  6,417|           1,038|       2,510|         2,426|     100 -  7,600|
