...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |117,088 | 229,434,142    | 276 |
...
The article data set contains information on 117,088 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 276 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 229,434,142. The average payment was € 1,960 and the median was € 1,773.

70,603 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 113,421,119, including value-added tax; the average payment was € 1,606 (median =  € 1,519, SD = € 792).

Hybrid open access journals rely on both publication fees and subscriptions as revenue source. 46,485 articles in the data set were published in hybrid journals. Total expenditure amounts to 116,013,024 €; the average fee was € 2,496 (median =  € 2,454, SD = € 998).
...
|2020   |       2,117|   1,869|     1,753|   2 -  5,832|             116|       2,657|         2,707|      493 - 5,317|
...
|DOI                        |  99.73%       |
|PubMed ID                  |  76.15%      |
|PubMed Central ID          |  69.49%     |
|Web of Science record ID   | 93.48%      |
