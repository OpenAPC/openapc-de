...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |188,441 | 364,265,902    | 402 |
...
The article data set contains information on 188,441 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 402 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 364,265,902. The average payment was € 1,933 and the median was € 1,785.

132,390 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 224,325,543, including value-added tax; the average payment was € 1,694 (median =  € 1,623, SD = € 793).

Hybrid open access journals rely on both publication fees and subscriptions as revenue source. 56,051 articles in the data set were published in hybrid journals. Total expenditure amounts to 139,940,359 €; the average fee was € 2,497 (median =  € 2,462, SD = € 1,010).
...
|2022   |      12,605|   2,021|     1,948|  12.36 -  9,044|           1,164|       2,733|         2,730|     2.1 - 11,988|
...
|Web of Science record ID   | 88.37%      |
