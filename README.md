...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |185,777 | 358,625,708    | 400 |
...
The article data set contains information on 185,777 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 400 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 358,625,708. The average payment was € 1,930 and the median was € 1,781.

129,865 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 219,017,838, including value-added tax; the average payment was € 1,687 (median =  € 1,615, SD = € 789).

Hybrid open access journals rely on both publication fees and subscriptions as revenue source. 55,912 articles in the data set were published in hybrid journals. Total expenditure amounts to 139,607,870 €; the average fee was € 2,497 (median =  € 2,462, SD = € 1,010).
...
|2022   |      10,474|   1,998|     1,931|  12.36 -  6,000|           1,059|       2,779|         2,733|     2.1 - 11,988|
