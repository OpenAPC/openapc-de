...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |151,991 | 291,535,351    | 357 |
...
The article data set contains information on 151,991 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 357 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 291,535,351. The average payment was € 1,918 and the median was € 1,750.

100,620 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 163,941,445, including value-added tax; the average payment was € 1,629 (median =  € 1,557, SD = € 771).
...
|2021   |       8,116|   1,777|     1,738|  27 -  6,417|           1,038|       2,510|         2,426|     100 -  7,600|
