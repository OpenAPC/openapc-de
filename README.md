...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |234,021 | 468,970,894    | 449 |
...
The article data set contains information on 234,021 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 449 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 468,970,894. The average payment was € 2,004 and the median was € 1,853.

171,216 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 309,161,569, including value-added tax; the average payment was € 1,806 (median =  € 1,697, SD = € 862).

Hybrid open access journals rely on both publication fees and subscriptions as revenue source. 62,805 articles in the data set were published in hybrid journals. Total expenditure amounts to 159,809,325 €; the average fee was € 2,545 (median =  € 2,500, SD = € 1,095).
...
|2023   |      15,592|   2,265|     2,153|  17.4 - 10,138|           2,246|       2,992|         2,813|   106.4 - 11,895|
|2024   |       1,281|   2,395|     2,338| 139.1 -  7,723|             237|       3,771|         3,385|   231.3 - 12,554|
...
In addition to APCs, additional costs have been reported for 400 articles, totalling € 243,350. The following table shows an overview of the different cost types:
...
|Web of Science record ID   | 70.42%         | NA                                                          |
