...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |146,161 | 280,812,600    | 351 |
...
The article data set contains information on 146,161 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 351 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 280,812,600. The average payment was € 1,921 and the median was € 1,747.

95,195 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 154,198,842, including value-added tax; the average payment was € 1,620 (median =  € 1,548, SD = € 772).

Hybrid open access journals rely on both publication fees and subscriptions as revenue source. 50,966 articles in the data set were published in hybrid journals. Total expenditure amounts to 126,613,758 €; the average fee was € 2,484 (median =  € 2,446, SD = € 993).
...
|DOI                        |  99.69%       |
|PubMed ID                  |  74.38%      |
|PubMed Central ID          |  68.03%     |
|Web of Science record ID   | 91.52%      |
