...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |182,061 | 351,585,667    | 396 |
...
The article data set contains information on 182,061 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 396 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 351,585,667. The average payment was € 1,931 and the median was € 1,778.

126,398 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 212,607,982, including value-added tax; the average payment was € 1,682 (median =  € 1,607, SD = € 789).

Hybrid open access journals rely on both publication fees and subscriptions as revenue source. 55,663 articles in the data set were published in hybrid journals. Total expenditure amounts to 138,977,686 €; the average fee was € 2,497 (median =  € 2,463, SD = € 1,009).
...
|2022   |       7,966|   2,039|     1,961|  12.36 -  6,000|             864|       2,846|         2,886|     5.0 -  9,700|
