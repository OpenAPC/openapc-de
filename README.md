...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |182,099 | 351,676,287    | 396 |
...
The article data set contains information on 182,099 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 396 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 351,676,287. The average payment was € 1,931 and the median was € 1,779.

126,413 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 212,632,310, including value-added tax; the average payment was € 1,682 (median =  € 1,607, SD = € 789).

Hybrid open access journals rely on both publication fees and subscriptions as revenue source. 55,686 articles in the data set were published in hybrid journals. Total expenditure amounts to 139,043,976 €; the average fee was € 2,497 (median =  € 2,463, SD = € 1,009).
...
|2021   |      22,631|   1,803|     1,776|  27.03 -  6,417|           2,846|       2,489|         2,475|    30.2 - 11,400|
|2022   |       7,981|   2,038|     1,961|  12.36 -  6,000|             887|       2,847|         2,884|     5.0 -  9,700|
