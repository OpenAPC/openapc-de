...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |186,600 | 360,207,524    | 401 |
...
The article data set contains information on 186,600 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 401 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 360,207,524. The average payment was € 1,930 and the median was € 1,782.

130,645 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 220,503,126, including value-added tax; the average payment was € 1,688 (median =  € 1,618, SD = € 789).
...
|2022   |      11,092|   1,995|     1,931|  12.36 -  9,044|           1,101|       2,759|         2,730|     2.1 - 11,988|
...
|Web of Science record ID   | 90.06%      |
