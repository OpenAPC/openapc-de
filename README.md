...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |123,859 | 240,593,702    | 290 |
...
The article data set contains information on 123,859 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 290 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 240,593,702. The average payment was € 1,942 and the median was € 1,761.

76,866 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 123,436,678, including value-added tax; the average payment was € 1,606 (median =  € 1,525, SD = € 778).
...
|2020   |       6,471|   1,713|     1,704|   0 -  5,832|             532|       2,319|         2,497|      260 - 5,317|
...
|DOI                        |  99.73%       |
|PubMed ID                  |  75.44%      |
|PubMed Central ID          |  68.99%     |
|Web of Science record ID   | 93.18%      |
