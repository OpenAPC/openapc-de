...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |127,680 | 247,196,274    | 309 |
...
The article data set contains information on 127,680 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 309 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 247,196,274. The average payment was € 1,936 and the median was € 1,756.

80,330 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 129,256,571, including value-added tax; the average payment was € 1,609 (median =  € 1,531, SD = € 775).

Hybrid open access journals rely on both publication fees and subscriptions as revenue source. 47,350 articles in the data set were published in hybrid journals. Total expenditure amounts to 117,939,703 €; the average fee was € 2,491 (median =  € 2,453, SD = € 998).
...
|2019   |      13,325|   1,639|     1,617|  11 -  7,684|           4,683|       2,427|         2,370|       75 - 9,500|
|2020   |       9,088|   1,700|     1,704|   0 -  5,832|             772|       2,238|         2,250|      145 - 5,317|
...
|Web of Science record ID   | 93.04%      |
