...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |205,934 | 401,603,806    | 426 |
...
The article data set contains information on 205,934 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 426 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 401,603,806. The average payment was € 1,950 and the median was € 1,810.

148,710 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 258,557,255, including value-added tax; the average payment was € 1,739 (median =  € 1,661, SD = € 812).

Hybrid open access journals rely on both publication fees and subscriptions as revenue source. 57,224 articles in the data set were published in hybrid journals. Total expenditure amounts to 143,046,551 €; the average fee was € 2,500 (median =  € 2,465, SD = € 1,018).
...
|2022   |      23,885|   2,068|     1,990|  12.36 -  9,044|           1,853|       2,698|         2,674|     2.1 - 14,607|
|2023   |       2,990|   2,136|     2,113|  50.00 -  6,332|             307|       2,828|         2,841|   481.0 - 11,895|
...
|Web of Science record ID   | 80.25%         | NA                                                          |
