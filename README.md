...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |154,248 | 295,616,272    | 357 |
...
The article data set contains information on 154,248 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 357 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 295,616,272. The average payment was € 1,916 and the median was € 1,752.

102,642 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 167,411,919, including value-added tax; the average payment was € 1,631 (median =  € 1,562, SD = € 767).

Hybrid open access journals rely on both publication fees and subscriptions as revenue source. 51,606 articles in the data set were published in hybrid journals. Total expenditure amounts to 128,204,353 €; the average fee was € 2,484 (median =  € 2,445, SD = € 997).
...
|2021   |      10,119|   1,766|     1,753|  27 -  6,417|           1,258|       2,537|         2,434|     100 -  8,341|
|2022   |          73|   1,884|     1,931| 421 -  4,006|              NA|          NA|            NA|               NA|
...
|Web of Science record ID   | 91.31%      |
