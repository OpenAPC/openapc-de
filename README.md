...
|------------------|-----------------|-------------------------|----------------------------------------|
| Articles         |127,684 | 247,202,294    | 309 |
...
The article data set contains information on 127,684 open access journal articles being published in fully and hybrid open access journal. Publication fees for these articles were supported financially by 309 research performing institutions and research funders. 

In total, article publication fee spending covered by the OpenAPC initiative amounted to € 247,202,294. The average payment was € 1,936 and the median was € 1,756.

80,334 articles in the data set were published in fully open access journals. Total spending on publication fees for these articles amounts to € 129,262,591, including value-added tax; the average payment was € 1,609 (median =  € 1,531, SD = € 775).
