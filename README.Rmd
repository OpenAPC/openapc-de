...
knitr::kable(costs_summary, col.names = c("Cost Type", "Total", "Occurence", "Median"))
```
...
p <- my_apc_opencost %>% 
  ...
  ggplot(aes(publisher, value, fill = name)) +
  geom_bar(stat="identity") +
  scale_fill_hue(labels = (c("Colour Charges", "Cover", "APC", "Other", "Page Charges", "Permission", "Publication Charges", "Reprint", "Submission Fee"))) +
