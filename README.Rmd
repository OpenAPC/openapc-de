...
In total, publication fee spending covered by the OpenAPC initiative amounted to € `r sum(my_apc$euro)`. The average payment was € `r mean(my_apc$euro)` and the median was € `r median(my_apc$euro)`.
