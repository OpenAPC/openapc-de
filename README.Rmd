...
my_cost_types <- my_costs %>%
  select("cover","colour_charges","page_charges","other","permission","publication_charges","reprint","submission_fee")
  
costs_summary <- tibble(
  type = c("cover","colour_charges","page_charges","other","permission","publication_charges","reprint","submission_fee"),
  total = vector("double", 8),
  count = vector("integer", 8),
  median = vector("double", 8)
)
...
knitr::kable(costs_summary, col.names = c("Kostenart", "Total", "Vorkommen", "Median"))
```
