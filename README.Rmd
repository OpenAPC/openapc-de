...
- to share a copy of [Directory of Open Access Journals (DOAJ)](http://doaj.org/) journal master list (downloaded January 2014) -> [data/doaj/doajJournalList.csv](data/data/doajJournalList.csv)
