...
At the moment, the dataset releases information on `r nrow(my.apc)` articles in open access journals that charges publication fees, with total expenditure of `r format(sum(my.apc$EURO), scientific=FALSE)`€. Average  fee is `r format(sum(my.apc$EURO)/nrow(my.apc), digits = 5)`€.
