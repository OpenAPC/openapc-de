...
oa_grouped <- my_apc %>%
    ...
    select(period, euro) %>%
    group_by(period) %>%
    ezsummary::ezsummary(n = TRUE, digits= 0, median = TRUE, mean = TRUE,
                       extra = c(
                         min = "min(., na.rm = TRUE)",
                         max = "max(., na.rm = TRUE)"
                        )) %>%
    ...
    ezmarkup('......[. - .]') %>%
    select(period, oa_n = n, oa_mean = mean, oa_median = median, oa_min_max = 'min - max')
...
hyb_grouped <- my_apc %>%
    ...
    ezmarkup('......[. - .]') %>%
    select(period, hyb_n = n, hyb_mean = mean, hyb_median = median, hyb_min_max = 'min - max')
...
frontlist_grouped <- my_bpc %>%
    ...
    ezmarkup('......[. - .]') %>%
    select(period,frontlist_n = n,frontlist_mean = mean,frontlist_median = median,frontlist_min_max = 'min - max')
...
backlist_grouped <- my_bpc %>%
    ...
    ezmarkup('......[. - .]') %>%
    select(period, backlist_n = n, backlist_mean = mean, backlist_median = median, backlist_min_max = 'min - max')
